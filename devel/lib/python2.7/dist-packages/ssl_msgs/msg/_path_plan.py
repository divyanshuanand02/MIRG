...
"""autogenerated by genpy from ssl_msgs/path_plan.msg. Do not edit."""
import codecs
import sys
...
class path_plan(genpy.Message):
  _md5sum = "26d1898b37a0c391ab33fae4f5394b29"
  _type = "ssl_msgs/path_plan"
...
float64 radius
"""
  __slots__ = ['start','goal','m_c','startTime','dynamic_obstacle','static_obstacle','biasWaypoints']
  _slot_types = ['ssl_msgs/LinearMotionInstant','ssl_msgs/LinearMotionInstant','ssl_msgs/MotionConstraints','time','ssl_msgs/DynamicObstacle[]','ssl_msgs/StaticObstacle[]','ssl_msgs/point_2d']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start,goal,m_c,startTime,dynamic_obstacle,static_obstacle,biasWaypoints
    ...
    """
    if args or kwds:
      super(path_plan, self).__init__(*args, **kwds)
      ...
      if self.static_obstacle is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.static_obstacle)
      buff.write(_struct_I.pack(length))
      for val1 in self.static_obstacle:
        _v2 = val1.pos
        _x = _v2
        buff.write(_get_struct_2d().pack(_x.x, _x.y))
        _x = val1.radius
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.static_obstacle = []
      for i in range(0, length):
        val1 = ssl_msgs.msg.StaticObstacle()
        _v4 = val1.pos
        _x = _v4
        start = end
        end += 16
        ...
        (val1.radius,) = _get_struct_d().unpack(str[start:end])
        self.static_obstacle.append(val1)
      _x = self
      start = end
      end += 16
